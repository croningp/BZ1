...
class BZBoard:
    ...
    def __init__(self, port):
        ...
        self.motors = { # [adafruit_shield, pin, min_speed]
            "A1":[1, 8, 500],"A2":[1, 9, 560],"A3":[1,10, 520],"A4":[1,11, 540],"A5":[1,12, 585],
            "B1":[1,14, 490],"B2":[1,15, 600],"B3":[1,13, 570],"B4":[1, 0, 600],"B5":[1, 1, 555],
            "C1":[1, 2, 620],"C2":[1, 3, 600],"C3":[1, 4, 510],"C4":[1, 5, 525],"C5":[1, 6, 640],
            "D1":[1, 7, 570],"D2":[0,4, 590],"D3":[0, 8, 550],"D4":[0, 9, 540],"D5":[0,10, 500],
