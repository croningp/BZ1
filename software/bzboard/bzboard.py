...
class BZBoard:
    ...
    def __init__(self, port):
        ...
        self.motors = { # [adafruit_shield, pin, min_speed]
            "A1":[1, 8, 500],"A2":[1, 9, 580],"A3":[1,10, 520],"A4":[1,11, 540],"A5":[1,12, 590],
            "B1":[1,14, 570],"B2":[1,15, 610],"B3":[1,13, 560],"B4":[1, 0, 650],"B5":[1, 1, 540],
            "C1":[1, 2, 510],"C2":[1, 3, 580],"C3":[1, 4, 570],"C4":[1, 5, 520],"C5":[1, 6, 650],
            "D1":[1, 7, 570],"D2":[0,4, 600],"D3":[0, 8, 550],"D4":[0, 9, 540],"D5":[0,10, 490],
            "E1":[0,11, 570],"E2":[0,12, 540],"E3":[0,13, 560],"E4":[0,14, 560],"E5":[0,15, 510]
            }
