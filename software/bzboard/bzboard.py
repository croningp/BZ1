...
class BZBoard:
    ...
    def __init__(self, port):
        ...
        self.motors = { # [adafruit_shield, pin, min_speed]
            "A1":[1, 8, 500],"A2":[1, 9, 510],"A3":[1,10, 560],"A4":[1,11, 540],"A5":[1,12, 600],
            "B1":[1,14, 560],"B2":[1,15, 570],"B3":[1,13, 600],"B4":[1, 0, 600],"B5":[1, 1, 580],
            "C1":[1, 2, 560],"C2":[1, 3, 550],"C3":[1, 4, 560],"C4":[1, 5, 490],"C5":[1, 6, 630],
            "D1":[1, 7, 560],"D2":[0,4, 570],"D3":[0, 8, 560],"D4":[0, 9, 570],"D5":[0,10, 500],
            "E1":[0,11, 550],"E2":[0,12, 520],"E3":[0,13, 560],"E4":[0,14, 570],"E5":[0,15, 540]
            }
